<?php
// Applique database/upgrade-007.sql à la base locale (idempotent : colonne déjà présente ignorée)
$pdo = new PDO('mysql:host=127.0.0.1;port=3306;dbname=procope_test;charset=utf8mb4', 'root', '', [
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
]);

$sql = file_get_contents(__DIR__ . '/../database/upgrade-007.sql');
...
echo "\nDESCRIBE job_offers :\n";
foreach ($pdo->query('DESCRIBE job_offers')->fetchAll(PDO::FETCH_ASSOC) as $col) {
