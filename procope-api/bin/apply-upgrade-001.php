<?php
// Applique database/upgrade-001.sql à la base locale (idempotent : ignore les colonnes déjà présentes)
$pdo = new PDO('mysql:host=127.0.0.1;port=3306;dbname=procope_test;charset=utf8mb4', 'root', '', [
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
]);

$sql = file_get_contents(__DIR__ . '/../database/upgrade-001.sql');
// Découpe en instructions (les commentaires -- sont ignorés par MySQL mais on nettoie pour le split)
...
foreach (['formations', 'inscriptions'] as $table) {
    echo "\nDESCRIBE $table :\n";
