...
<div class="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
    ...
    <div class="relative w-full max-w-md">
        <div class="rounded-3xl bg-white p-8 shadow-2xl ring-1 ring-white/20 sm:p-10">
            ...
            <form method="post" action="/admin/login" autocomplete="off" class="space-y-5" data-loading-submit>
                <?= csrf_field() ?>
                <div>
                ...
                <button class="btn-primary w-full py-3 text-base disabled:pointer-events-none disabled:opacity-70" type="submit" data-loading-submit>
                    <span data-loading-idle class="inline-flex items-center gap-2">
                        <?= icon('logout', 'h-5 w-5 -scale-x-100') ?> Se connecter
                    </span>
                    <span data-loading-busy class="hidden inline-flex items-center gap-2" aria-hidden="true">
